  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-5 z-50">
      <div className="bg-white w-full max-w-xs rounded-3xl p-6 shadow-2xl animate-fade-scale-in">
        <h4 className="font-bold text-[#1A1D29] text-base mb-1">Edit Bike Details</h4>
        <p className="text-xs text-[#6B7280] mb-4">Update name, driver, or daily rent</p>
        ...
        <div className="flex gap-2">
          <button onClick={onClose} disabled={saving} className="flex-1 py-3 text-xs font-bold bg-[#F4F5F7] rounded-xl text-[#6B7280] disabled:opacity-50">
            Cancel
          </button>
