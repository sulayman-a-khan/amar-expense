  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-5 z-50">
      <div className="bg-[#FFFDF8] w-full max-w-xs rounded-3xl p-6 shadow-2xl animate-fade-scale-in">
        <h4 className="font-bold text-[#2B2620] text-base mb-1">Add New Bike</h4>
        <p className="text-xs text-[#6B5F4F] mb-4">Add a vehicle to your fleet</p>
        ...
        <div className="flex gap-2">
          <button onClick={handleClose} disabled={saving} className="flex-1 py-3 text-xs font-bold bg-[#F7F3EA] rounded-xl text-[#6B5F4F] disabled:opacity-50">
            Cancel
          </button>
